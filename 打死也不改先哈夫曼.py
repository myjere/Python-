...
6. 文件压缩
'''
def compressfile(inputfile,fileafterrle):
    print("开始压缩！")
    # 0.进行游程编码压缩
    print("开始游程编码！")
...
7.文件解压
'''
def decompressfile(fileinput,fileoutput):
    print("开始解压！")
    # 1.哈夫曼编码解压缩初始化
    print("开始哈夫曼解码！")
    count = 0
...
if __name__ == '__main__':
    ...
    if input("请输入要执行的操作\n1.压缩文件   2.解压文件\n") == '1':
        ...
        while i < 6:
            ...
            i = i+1
        # 2.固定文件压缩测试
        #compressfile('C:\\Users\\Jeremy\\Desktop\\1.bmp','C:\\Users\\Jeremy\\Desktop\\10.temp')
        # 3.自定义文件压缩测试
        ...
        while i < 6:
            ...
            i = i+1
        # 2.固定文件解压测试
        #decompressfile('C:\\Users\\Jeremy\\Desktop\\reco\\1.wr','C:\\Users\\Jeremy\\Desktop\\reco\\1.bmp')
        # 3.自定义文件解压测试
